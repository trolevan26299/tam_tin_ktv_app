...
export default function CheckDeviceView() {
  ...
  return (
    <div className="container mx-auto p-6 ">
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-lg p-3 shadow-lg flex flex-col ">
          ...
          selectedCustomer.history_repair.length > 0 ? (
            <div className="mt-3 space-y-2 h-[100%] overflow-y-auto">
              {[...selectedCustomer.history_repair]
                .sort(
                  (a, b) =>
                    new Date(b.date_repair).getTime() -
                    new Date(a.date_repair).getTime()
                )
                .map((history) => (
                  <div
                    key={history._id}
        ...
        border border-gray-100"
                  >
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <div
                        className="px-4 py-0 bg-gradient-to-r from-blue-500 to-blue-600 
                    ...
                    <div className="mb-1">
                      ...
                      <div className=" gap-3 w-full">
                        {history.linh_kien.map((lk, index) => (
                          <div
                            key={index}
                            className="bg-white/60 mb-[2px] px-2 py-1 rounded-lg text-sm border border-gray-100
               hover:bg-white/80 transition-colors duration-200 w-full"
                    ...
                    {history.note && (
                      <div>
                        ...
                        <div className="bg-white/60 p-1 rounded-lg text-gray-700 text-sm border border-gray-100 pl-2">
                          {history.note}
                        </div>
                      </div>
                    )}
            ...
            <div className="text-center py-8 mt-6 bg-white/50 backdrop-blur-sm rounded-xl flex flex-col justify-center h-[40vh] overflow-y-auto">
              <div className="text-gray-500 font-medium">
                Khách hàng này chưa có lịch sử sửa chữa.
              </div>
            </div>
          ) : (
            <div className="text-center py-4 mt-6 overflow-y-auto flex flex-col justify-center h-[40vh]">
